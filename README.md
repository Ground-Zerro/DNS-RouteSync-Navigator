...
4. Узнайте ID VPN этого подключения:
...
8. Установите IP-адрес VPS или ПК с настроенным и запущенным DNS-RouteSync-Navigator в качестве основного DNS-сервера на вашем роутере.
9. Если все сделанно правильно в логе работы побегут строчки.
